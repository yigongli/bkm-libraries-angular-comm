...
(function() {
    ...
    function bkmSettleService() {
        ...
        self.downstreamSettlementComputing = function(settleParams) {
            ...
            v.downstreamLossAmount = Math.round(v.downstreamLossAmount * 100) / 100;
            //下游结算数量: 判断下游结算数量策略
            ...
            //下游原始运费金额：结算数量 * 运费单价
            v.freightAmount = Math.round(v.downstreamFinalWeight * v.freightPrice * 100) / 100;
            //下游含税运费金额：结算数量 * 含税运费单价
            v.taxedFreightAmount = Math.round(v.downstreamFinalWeight * v.downTaxedFreightPrice * 100) / 100;
            //下游裸运费金额：结算数量 * 裸运费单价
            v.noTaxedFreightAmount = Math.round(v.downstreamFinalWeight * v.noDownTaxedFreightPrice * 100) / 100;
            ...
            v.downstreamFinalAmount = Math.round(v.downstreamFinalAmount * 100) / 100;
            //下游税费
